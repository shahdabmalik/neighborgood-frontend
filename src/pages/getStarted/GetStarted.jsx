        ...
        <div className='w-full bg-white dark:bg-slate-950 transition-none md:transition-colors duration-300 ease-linear' >
            ...
            <div className="max-w-screen-2xl mx-auto min-h-screen flex flex-col items-center justify-center px-4 md:px-10" >
                <div className="flex justify-center w-full ">
                    <div className="p-4 max-w-sm min-h-[450px] w-full rounded-md md:rounded-e-none shadow-xl border dark:bg-slate-900 border-primary overflow-hidden flex flex-col" >
                        <div>
                        ...
                        <div className="flex-grow" >
                            <div className="flex flex-col gap-5 border-b border-slate-300 dark:border-slate-700 pb-5 mt-8 mb-5" >
                                <Link to={"/login"} className="bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-400 hover:bg-blue-700 text-white dark:text-black flex gap-2 items-center justify-center rounded h-10 font-medium" > <MdEmail size={18} /> Login </Link>
                                <Link to={"/register"} className="bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-400 text-white dark:text-black flex gap-2 items-center justify-center rounded h-10 font-medium" > <MdEmail size={18} />SignUp</Link>
                            </div>
                            <GoogleLoginButton />
                        </div>
