...
const Profile = () => {
    ...
    return (
        <div className="w-full bg-white dark:bg-slate-950 transition-all duration-300 ease-linear min-h-screen px-4 md:px-10" >
            <Navbar>
            ...
            <div className="max-w-screen-lg mx-auto pt-32 pb-24" >
                <div className="flex flex-col md:flex-row gap-10 md:gap-5 lg:gap-10" >
                    ...
                    <div className=" flex flex-col gap-4 px-4 pb-4 pt-2 border border-slate-300 dark:border-slate-700 shadow-xl shadow-slate-200 dark:shadow-none flex-grow rounded-md transition-all duration-300 ease-linear" >
                        <div className="border-b pb-2 border-slate-300 dark:border-slate-700 transition-all duration-300 ease-linear">
                            ...
                            <p className="mt-1 text-sm text-slate-700 dark:text-slate-300 transition-all duration-300 ease-linear" >Similarity: 73.5% </p>
                        </div>
                        <div className="flex-grow flex flex-col justify-center gap-4 text-slate-700 dark:text-slate-300 transition-all duration-300 ease-linear" >
                        ...
                        <div className=" " >
                            <button type="button" className=" w-full flex gap-2 justify-center rounded font-semibold text-black bg-primary-light hover:bg-primary transition-all items-center border border-primary-light px-4 py-2" >Message <TbMessageCircle2Filled size={20} /></button>
                        </div>
                    </div>
                </div>
                <div className="mt-12 border p-4 pb-7 border-slate-300 dark:border-slate-700 shadow-xl shadow-slate-200 dark:shadow-none flex-grow rounded-md transition-all duration-300 ease-linear" >
