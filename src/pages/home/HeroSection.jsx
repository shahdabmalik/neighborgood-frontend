...
const HeroSection = () => {
    ...
    const imageAnimation = {
        ...
        show: { opacity: 1, scale: 1, transition: { duration: 0.5, delay: 0.25 } }
    }
    const containerAni = {
        hidden: { opacity: 0 },
    ...
    return (
        <div className="min-h-screen flex gap-12 md:gap-4 flex-col justify-center items-center overflow-hidden" >
            ...
            <motion.div
                ...
                <motion.h1 variants={itemAni} className="text-5xl h-16 sm:text-6xl sm:h-20 font-bold inline-block bg-gradient-to-r from-primary-light to-primary-dark text-transparent bg-clip-text" >Neighborgood</motion.h1>
